...
def handle_online_course_details(message):
    bot.send_message(
        ...
        '➡️Запись на тренировки начнется утром 29 июля🌺😍\n'
        ...
        '▶️Старт тренировок - 3 августа‼️( будет загружена уже первая тренировка )\n\n'
        ...
        'Нужно будет сделать обязательно фото вашей фигуры до начала тренировок.\n\n'
        'Выполнять тренировки 3 раза в неделю — обязательный пункт! Так как это группа онлайн, надеемся на ваше ответственное отношение к выполнению тренировок. В случае пропуска тренировки по вашим личным обстоятельствам тренировка не сохраняется и не отправляется в сообщениях 🫶🏽🙏🏽\n\n'
        'Поддержка осуществляется в закрытой группе в WhatsApp📍\n\n'
        '➡️Что нужно из инвентаря: коврик для занятий, резинки (желательно набор с разной нагрузкой, от легких до сильных). Их много на Wildberries или Ozon. Гантели (минимум 2 кг для новичков, не новички могут взять по 4 или 5 кг). Я посоветую, какие лучше взять.\n\n'
        '✨По питанию: на странице будет 2х часовое видео от Каринэ (доступно только до 31 августа), все подробно о питании, КБЖУ и как будем формировать наш рацион. (Конкретного меню с рецептами не будет).\n\n'
