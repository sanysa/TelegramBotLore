...
def handle_online_course_details(message):
    bot.send_message(message.chat.id,
                     ...
                     '➡️Запись на тренировки начнется утром 18 июня🌺😍\n'
                     ...
                     '➡️Старт тренировок - 24 июня‼️( будет загружена уже первая тренировка).\n\n'
                     ...
                     '✨По питанию: на странице будет 2х часовое видео от Каринэ (доступно только до 15 июня), все подробно о питании , кбжу и как будем формировать наш рацион. (Конкретного меню с рецептами не будет).\n\n'
