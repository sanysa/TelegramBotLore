...
def handle_online_course_details(message):
    bot.send_message(message.chat.id,
                     ...
                     '✨По питанию: на странице будет 2х часовое видео от Каринэ (доступно только до 22 июля), все подробно о питании , кбжу и как будем формировать наш рацион. (Конкретного меню с рецептами не будет).\n\n'
